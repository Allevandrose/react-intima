...
const HomePage = () => {
  ...
  return (
    <>
      <SEO
        title="Intimacare Kenya - Premium Adult Toys & Sexual Wellness"
        description="Shop premium adult toys, vibrators, dildos, lingerie & intimacy products in Kenya. Discreet delivery in Nairobi, Mombasa, Kisumu. M-Pesa accepted."
        keywords="Intimacare Kenya, adult toys Kenya, sex toys Nairobi, discreet delivery, sexual wellness"
        url="/"
      />
          ...
          <div className="max-w-7xl mx-auto px-5 sm:px-8 relative z-10">
            <div className="max-w-2xl">
              ...
              <p className="text-[#EAC7C7] text-lg leading-relaxed mb-10 max-w-xl">
                ...
                discreet packaging, secure payments, and fast delivery across
                Kenya.
              </p>
