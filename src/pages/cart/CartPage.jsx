...
const CartPage = () => {
  ...
  if (isLoading) {
    return (
      <>
        <SEO
          title="Loading Cart | Intimacare Kenya"
          description="Loading your shopping cart at Intimacare Kenya. Premium adult toys with discreet delivery across Kenya."
          url="/cart"
        />
  ...
  if (items.length === 0) {
    return (
      <>
        <SEO
          title="Shopping Cart | Intimacare Kenya"
          description="Review your cart items at Intimacare Kenya. Secure checkout with M-Pesa and discreet delivery across Kenya."
          url="/cart"
        />
  ...
  return (
    <>
      <SEO
        title={`Shopping Cart (${totalItems} items) | Intimacare Kenya`}
        description={`Review your cart with ${totalItems} items at Intimacare Kenya. Secure checkout with M-Pesa and discreet delivery across Kenya.`}
        keywords="shopping cart, Intimacare cart, adult toys Kenya, checkout Kenya"
        url="/cart"
      />
