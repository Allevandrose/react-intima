...
const ShopPage = () => {
  ...
  return (
    <>
      <SEO
        title="Shop Adult Toys Online in Kenya | Intimacare"
        description="Browse our collection of premium adult toys, vibrators, dildos, and intimacy products. Discreet shipping across Kenya with M-Pesa payments."
        keywords="shop adult toys Kenya, buy sex toys Nairobi, online sex shop Kenya, adult toys store"
        url="/shop"
      />
