...
const PaymentSuccess = () => {
  ...
  // ✅ Extract verifyOrder as a separate function for reuse
  ...
  // ✅ Separate function for showing success alert and redirecting
  const showSuccessAlert = async (order) => {
    ...
    const totalAmount = order?.totalAmount || orderData?.totalAmount || 0;
    ...
    await Swal.fire({
      ...
      // ✅ Only navigate if not already done
